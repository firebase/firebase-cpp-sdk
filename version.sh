...
declare -A POD_SDK_VERSIONS=(
  ["released"]="6.5.0"  # gen_build.sh: [FIR] Managed by a script. DO NOT EDIT.
  ["stable"]="6.5.0"  # gen_build.sh: [FIR] Managed by a script. DO NOT EDIT.
  ["head"]="6.5.0"  # gen_build.sh: [FIR] Managed by a script. DO NOT EDIT.
)

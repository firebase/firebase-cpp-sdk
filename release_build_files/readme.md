...
-------------------------- | --------------------------------------
All Firebase SDKs          | platform(com.google.firebase:firebase-bom:34.12.0)
...
|                          | androidx.core:core:1.18.0  (Maven package)
...
|                          | (Maven package)
Google Play services module| com.google.android.gms:play-services-base:18.10.0
|                          | (Maven package)
...
|                          | libfirebase_app.a
|                          | Firebase/CloudMessaging Cocoapod (12.12.0)
Firebase Realtime Database | libfirebase_database.a
|                          | libfirebase_app.a
|                          | libfirebase_auth.a
|                          | Firebase/Database Cocoapod (12.12.0)

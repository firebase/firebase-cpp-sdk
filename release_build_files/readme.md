...
|                          | androidx.core:core:1.6.0  (Maven package)
...
|                          | Firebase/Analytics Cocoapod (8.4.0)
...
-   Changes
    -   Firestore: Added `operator==` and `operator!=` for `SnapshotMetadata`,
        `Settings`, and `QuerySnapshot`, `SetOptions`, and `DocumentChange`.

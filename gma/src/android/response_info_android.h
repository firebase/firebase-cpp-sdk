...
#ifndef FIREBASE_ADMOB_SRC_ANDROID_RESPONSE_INFO_ANDROID_H_
#define FIREBASE_ADMOB_SRC_ANDROID_RESPONSE_INFO_ANDROID_H_
...
#endif  // FIREBASE_ADMOB_SRC_ANDROID_RESPONSE_INFO_ANDROID_H_

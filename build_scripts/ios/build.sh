...
readonly SUPPORTED_TARGETS=(firebase_analytics firebase_auth firebase_database firebase_dynamic_links firebase_functions firebase_installations firebase_messaging firebase_remote_config firebase_storage)

 ...
 *  via the FIRMessagingDelegate method `-message:didReceiveRegistrationToken:`, or by
 ...
 */
@property(nonatomic, readwrite, nullable) NSString *FCMToken NS_SWIFT_NAME(fcmToken);
 ...
 *
 *  @param topic The name of the topic, for example, @"sports".
 *  @param completion The completion that is invoked once the subscribe call ends. In case of
 *                    success, nil error is returned. Otherwise, an appropriate error object is
 *                    returned.
 */

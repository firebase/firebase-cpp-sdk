...
#ifndef FIREBASE_STORAGE_SRC_ANDROID_CONTROLLER_ANDROID_H_
#define FIREBASE_STORAGE_SRC_ANDROID_CONTROLLER_ANDROID_H_
...
#endif  // FIREBASE_STORAGE_SRC_ANDROID_CONTROLLER_ANDROID_H_

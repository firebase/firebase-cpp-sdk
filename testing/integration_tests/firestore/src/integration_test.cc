...
TEST_F(FirebaseFirestoreBasicTest, TestSetDelete) {
  ...
  // TODO(b/139064606): Test error cases (deleting invalid path, etc.)
}
...
// TODO(b/139064606): Add test for failing transaction.
...
TEST_F(FirebaseFirestoreBasicTest,
  ...
  delete firestore_;
  firestore_ = nullptr;
  // TODO(b/139064606): Ensure existing Firestore objects are invalidated.
}
...
// TODO(b/139064606): Add test for Auth signout while connected.

// TODO(b/139064606): Add additional comprehensive tests as needed.

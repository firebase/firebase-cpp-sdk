...
#ifndef FIREBASE_APP_CLIENT_SRC_INCLUDE_FIREBASE_APP_H_
#define FIREBASE_APP_CLIENT_SRC_INCLUDE_FIREBASE_APP_H_
...
#endif  // FIREBASE_APP_CLIENT_SRC_INCLUDE_FIREBASE_APP_H_

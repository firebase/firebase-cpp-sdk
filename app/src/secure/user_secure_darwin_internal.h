...
#ifndef FIREBASE_APP_SRC_SECURE_USER_SECURE_DARWIN_INTERNAL_H_
#define FIREBASE_APP_SRC_SECURE_USER_SECURE_DARWIN_INTERNAL_H_
...
#endif  // FIREBASE_APP_SRC_SECURE_USER_SECURE_DARWIN_INTERNAL_H_

...
#ifndef FIREBASE_APP_CHECK_SRC_ANDROID_RECAPTCHA_PROVIDER_ANDROID_H_
#define FIREBASE_APP_CHECK_SRC_ANDROID_RECAPTCHA_PROVIDER_ANDROID_H_
...
#endif  // FIREBASE_APP_CHECK_SRC_ANDROID_RECAPTCHA_PROVIDER_ANDROID_H_

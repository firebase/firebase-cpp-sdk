...
#ifndef FIREBASE_TESTLAB_CLIENT_CPP_SRC_INCLUDE_FIREBASE_TESTLAB_H_
#define FIREBASE_TESTLAB_CLIENT_CPP_SRC_INCLUDE_FIREBASE_TESTLAB_H_
...
#endif  // FIREBASE_TESTLAB_CLIENT_CPP_SRC_INCLUDE_FIREBASE_TESTLAB_H_

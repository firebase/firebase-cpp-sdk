#ifndef FIREBASE_FIRESTORE_CLIENT_CPP_SRC_MAIN_SET_OPTIONS_MAIN_H_
#define FIREBASE_FIRESTORE_CLIENT_CPP_SRC_MAIN_SET_OPTIONS_MAIN_H_
...
#endif  // FIREBASE_FIRESTORE_CLIENT_CPP_SRC_MAIN_SET_OPTIONS_MAIN_H_

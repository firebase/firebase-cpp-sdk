#ifndef FIREBASE_FIRESTORE_CLIENT_CPP_SRC_MAIN_CREATE_FIREBASE_METADATA_PROVIDER_H_
...
#endif  // FIREBASE_FIRESTORE_CLIENT_CPP_SRC_MAIN_CREATE_FIREBASE_METADATA_PROVIDER_H_

#ifndef FIREBASE_FIRESTORE_CLIENT_CPP_SRC_MAIN_CREDENTIALS_PROVIDER_DESKTOP_H_
#define FIREBASE_FIRESTORE_CLIENT_CPP_SRC_MAIN_CREDENTIALS_PROVIDER_DESKTOP_H_
...
#endif  // FIREBASE_FIRESTORE_CLIENT_CPP_SRC_MAIN_CREDENTIALS_PROVIDER_DESKTOP_H_

...
StaticField<Object> kServer("SERVER", "Lcom/google/firebase/firestore/AggregateSource;");
...
Local<Object> AggregateSourceInternal::Create(Env& env, AggregateSource aggregate_source) {

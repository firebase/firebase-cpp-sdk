...
Future<AggregateQuerySnapshot> AggregateQueryInternal::Get(AggregateSource aggregate_source) {
  Env env = GetEnv();
  Local<Object> java_source = AggregateSourceInternal::Create(env, aggregate_source);

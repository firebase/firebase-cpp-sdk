...
#pragma clang attribute push(                                             \
        __attribute__((external_source_symbol(                            \
                language = "Swift", defined_in = "FirebaseFunctions",     \
...
/// <code>Functions</code> is the client for Cloud Functions for a Firebase
/// project.
SWIFT_CLASS_NAMED("Functions")
@interface FIRFunctions : NSObject
/// Creates a Cloud Functions client using the default or returns a pre-existing
...
/// Creates a Cloud Functions client with the given app, or returns a
...
/// \param region The region for the HTTP trigger, such as
/// <code>us-central1</code>.
///
///
/// returns:
/// A shared Functions instance initialized with the default
/// <code>FirebaseApp</code> and a custom region.
...
/// returns:
/// A shared Functions instance initialized with the default
/// <code>FirebaseApp</code> and a custom HTTP trigger domain.
+ (FIRFunctions* _Nonnull)functionsForCustomDomain:
    (NSString* _Nonnull)customDomain SWIFT_WARN_UNUSED_RESULT;
/// Creates a Cloud Functions client with the given app and region, or returns a
/// pre-existing instance if one already exists. \param app The app for the
/// Firebase project.
///
...
///
/// returns:
/// An instance of <code>Functions</code> with a custom app and HTTP trigger
/// domain.
+ (FIRFunctions* _Nonnull)functionsForApp:(FIRApp* _Nonnull)app
...
- (FIRHTTPSCallable* _Nonnull)HTTPSCallableWithName:(NSString* _Nonnull)name
    SWIFT_WARN_UNUSED_RESULT;
/// Creates a reference to the Callable HTTPS trigger with the given name and
/// configuration options. \param name The name of the Callable HTTPS trigger.
///
/// \param options The options with which to customize the Callable HTTPS
/// trigger.
///
///
/// returns:
/// A reference to a Callable HTTPS trigger.
- (FIRHTTPSCallable* _Nonnull)
    HTTPSCallableWithName:(NSString* _Nonnull)name
...
- (FIRHTTPSCallable* _Nonnull)HTTPSCallableWithURL:(NSURL* _Nonnull)url
    SWIFT_WARN_UNUSED_RESULT;
/// Creates a reference to the Callable HTTPS trigger with the given name and
/// configuration options. \param url The URL of the Callable HTTPS trigger.
///
/// \param options The options with which to customize the Callable HTTPS
/// trigger.
///
...
/// A reference to a Callable HTTPS trigger.
- (FIRHTTPSCallable* _Nonnull)
    HTTPSCallableWithURL:(NSURL* _Nonnull)url
                 options:(FIRHTTPSCallableOptions* _Nonnull)options
    SWIFT_WARN_UNUSED_RESULT;
...
typedef SWIFT_ENUM_NAMED(NSInteger, FIRFunctionsErrorCode, "FunctionsErrorCode",
    ...
    /// <code>InvalidArgument</code> indicates arguments that are problematic
    ...
    /// Internal errors. Means some invariant expected by underlying system has
    /// been broken. If you
...
/// A <code>HTTPSCallable</code> is a reference to a particular Callable HTTPS
/// trigger in Cloud Functions.
...
///   </li>
///   <li>
///     <code>NSNumber</code>, or any Swift numeric type bridgeable to
///     <code>NSNumber</code>
///   </li>
///   <li>
///     <code>[Any]</code>, where the contained objects are also one of these
///     types.
///   </li>
///   <li>
...
///   </li>
/// </ul>
/// The request to the Cloud Functions backend made by this method automatically
/// includes a Firebase Installations ID token to identify the app instance. If
/// a user is logged in with Firebase Auth, an auth ID token for the user is
/// also automatically included. Firebase Cloud Messaging sends data to the
/// Firebase backend periodically to collect information regarding the app
/// instance. To stop this, see <code>Messaging.deleteData()</code>. It resumes
/// with a new FCM Token the next time you call this method. \param data
...
- (void)callWithObject:(id _Nullable)data
            completion:(void (^_Nonnull)(FIRHTTPSCallableResult* _Nullable,
                                         NSError* _Nullable))completion;
/// Executes this Callable HTTPS trigger asynchronously. This API should only be
/// used from Objective-C. The request to the Cloud Functions backend made by
/// this method automatically includes a Firebase Installations ID token to
...
/// <code>Messaging.deleteData()</code>. It resumes with a new FCM Token the
...
/// Whether or not to protect the callable function with a limited-use App Check
/// token.
@property(nonatomic, readonly) BOOL requireLimitedUseAppCheckTokens;
/// Designated initializer.
/// \param requireLimitedUseAppCheckTokens A boolean used to decide whether or
/// not to protect the callable function with a limited use App Check token.
///
...
/// A <code>HTTPSCallableResult</code> contains the result of calling a
/// <code>HTTPSCallable</code>.
...
/// The data is in the form of native objects. For example, if your trigger
/// returned an array, this object would be an <code>Array<Any></code>. If your
/// trigger returned a JavaScript object with keys and values, this object would
/// be an instance of <code>[String: Any]</code>.

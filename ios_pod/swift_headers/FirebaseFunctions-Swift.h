...
/// pre-existing instance if one already exists.
...
/// returns a pre-existing instance if one already exists.
/// \param app The app for the Firebase project.
///
/// \param customDomain A custom domain for the HTTP trigger, such as
...
/// with a new FCM Token the next time you call this method.
...
/// next time you call this method.
/// \param completion The block to call when the HTTPS request has completed.
///

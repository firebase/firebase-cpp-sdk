...
// Copied from Firebase iOS SDK 12.10.0.
...
/// with custom <code>FirebaseApp</code>.
...
+ (FIRStorage* _Nonnull)storageForApp:(FIRApp* _Nonnull)app
    SWIFT_WARN_UNUSED_RESULT;
/// Creates an instance of <code>Storage</code>, configured with a custom
/// <code>FirebaseApp</code> and a custom storage bucket URL.
/// \param app The custom <code>FirebaseApp</code> used for initialization.
///
/// \param url The <code>gs://</code> url to your Firebase Storage bucket.
///
...
/// by the <code>path</code> parameter.
...
/// <code>write(toFile:)</code> may be a better option.
/// \param maxSize The maximum size in bytes to download. If the download
/// exceeds this size, the task will be cancelled and an error will be returned.
///
...
/// Firebase Rules Version 2.
/// \param completion A completion handler that will be invoked with all items
/// and prefixes under the current <code>StorageReference</code>.
///
...
/// available for projects using Firebase Rules Version 2.
/// \param maxResults The maximum number of results to return in a single page.
/// Must be greater than 0 and at most 1000.
///

...
// Copied from Firebase iOS SDK 10.14.0.
...
/// Instances of <code>Storage</code> are not thread-safe, but can be accessed
/// from any thread. If you call <code>Storage.storage()</code>, the instance
/// will initialize with the default <code>FirebaseApp</code>,
/// <code>FirebaseApp.app()</code>, and the storage location will come from the
/// provided <code>GoogleService-Info.plist</code>. If you provide a custom
/// instance of <code>FirebaseApp</code>, the storage location will be specified
/// via the <code>FirebaseOptions.storageBucket</code> property.

...
// Copied from Firebase iOS SDK 9.6.0.
...
/// Creates a StorageReference given a <code>gs://</code> or <code>https://</code> URL pointing to a
/// Firebase Storage location. For example, you can pass in an <code>https://</code> download URL
/// retrieved from <code>StorageReference.downloadURL(completion:)</code> or the <code>gs://</code>
/// URL from <code>StorageReference.description</code>. \param url A gs // or https:// URL to
/// initialize the reference with.
///
///
/// throws:
...
/// unspecified. Currently all uploads must be initiated and managed on the main queue.

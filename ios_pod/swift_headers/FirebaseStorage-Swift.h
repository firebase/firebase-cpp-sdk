...
/// methods on a new instance of <code>Storage</code>. \param host A string
/// specifying the host.
///
...
/// A token that can be used to resume a previous <code>list()</code> operation.
...
/// documentation can be found in the <a
...
/// get/set object metadata, and delete an object at the path. See the <a
/// href="https://cloud.google.com/storage/">Cloud docs</a>  for more details.
...
/// system filepath. <ul>
///   <li>
///     Returns A <code>StorageDownloadTask</code> that can be used to monitor

...
#pragma clang attribute push(                                                  \
    __attribute__((external_source_symbol(language = "Swift",                  \
                                          defined_in = "FirebaseCoreInternal", \
...
/// An object that provides API to log and flush heartbeats from a synchronized
/// storage container.
SWIFT_CLASS_NAMED("_ObjC_HeartbeatController")
@interface FIRHeartbeatController : NSObject
/// Public initializer.
/// \param id The <code>id</code> to associate this controller’s heartbeat
/// storage with.
///
...
/// \param agent The string agent (i.e. Firebase User Agent) to associate the
/// logged heartbeat with.
///
...
- (void)flushAsyncWithCompletionHandler:
    (void (^_Nonnull)(FIRHeartbeatsPayload* _Nonnull))completionHandler;
...
- (FIRHeartbeatsPayload* _Nonnull)
    flushHeartbeatFromToday SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

/// A model object representing a payload of heartbeat data intended for sending
/// in network requests.

...
@property(nonatomic, readonly)
    enum FIRSessionsSubscriberName sessionsSubscriberName;
@end

/// Session Subscriber Names are used for identifying subscribers
typedef SWIFT_ENUM_NAMED(NSInteger, FIRSessionsSubscriberName,
                         "SessionsSubscriberName", open){

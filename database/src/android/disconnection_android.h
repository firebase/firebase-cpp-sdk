...
#ifndef FIREBASE_DATABASE_SRC_ANDROID_DISCONNECTION_ANDROID_H_
#define FIREBASE_DATABASE_SRC_ANDROID_DISCONNECTION_ANDROID_H_
...
#endif  // FIREBASE_DATABASE_SRC_ANDROID_DISCONNECTION_ANDROID_H_

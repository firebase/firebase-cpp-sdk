...
#ifndef FIREBASE_DATABASE_SRC_ANDROID_UTIL_ANDROID_H_
#define FIREBASE_DATABASE_SRC_ANDROID_UTIL_ANDROID_H_
...
#endif  // FIREBASE_DATABASE_SRC_ANDROID_UTIL_ANDROID_H_

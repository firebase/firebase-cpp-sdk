...
#ifndef FIREBASE_DATABASE_SRC_DESKTOP_VIEW_EVENT_TYPE_H_
#define FIREBASE_DATABASE_SRC_DESKTOP_VIEW_EVENT_TYPE_H_
...
#endif  // FIREBASE_DATABASE_SRC_DESKTOP_VIEW_EVENT_TYPE_H_

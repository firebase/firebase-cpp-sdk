...
#ifndef FIREBASE_DATABASE_SRC_DESKTOP_DATABASE_DESKTOP_H_
#define FIREBASE_DATABASE_SRC_DESKTOP_DATABASE_DESKTOP_H_
...
#endif  // FIREBASE_DATABASE_SRC_DESKTOP_DATABASE_DESKTOP_H_

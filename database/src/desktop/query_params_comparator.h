...
#ifndef FIREBASE_DATABASE_SRC_DESKTOP_QUERY_PARAMS_COMPARATOR_H_
#define FIREBASE_DATABASE_SRC_DESKTOP_QUERY_PARAMS_COMPARATOR_H_
...
#endif  // FIREBASE_DATABASE_SRC_DESKTOP_QUERY_PARAMS_COMPARATOR_H_

...
#ifndef FIREBASE_DATABASE_SRC_DESKTOP_CORE_COMPOUND_WRITE_H_
#define FIREBASE_DATABASE_SRC_DESKTOP_CORE_COMPOUND_WRITE_H_
...
#endif  // FIREBASE_DATABASE_SRC_DESKTOP_CORE_COMPOUND_WRITE_H_

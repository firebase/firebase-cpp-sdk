...
#ifndef FIREBASE_DATABASE_SRC_DESKTOP_CORE_INFO_LISTEN_PROVIDER_H_
#define FIREBASE_DATABASE_SRC_DESKTOP_CORE_INFO_LISTEN_PROVIDER_H_
...
#endif  // FIREBASE_DATABASE_SRC_DESKTOP_CORE_INFO_LISTEN_PROVIDER_H_

...
#ifndef FIREBASE_DATABASE_SRC_DESKTOP_CORE_KEEP_SYNCED_EVENT_REGISTRATION_H_
#define FIREBASE_DATABASE_SRC_DESKTOP_CORE_KEEP_SYNCED_EVENT_REGISTRATION_H_

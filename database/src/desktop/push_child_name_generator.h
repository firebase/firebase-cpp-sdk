...
#ifndef FIREBASE_DATABASE_SRC_DESKTOP_PUSH_CHILD_NAME_GENERATOR_H_
#define FIREBASE_DATABASE_SRC_DESKTOP_PUSH_CHILD_NAME_GENERATOR_H_
...
#endif  // FIREBASE_DATABASE_SRC_DESKTOP_PUSH_CHILD_NAME_GENERATOR_H_

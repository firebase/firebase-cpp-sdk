...
#ifndef FIREBASE_DATABASE_SRC_DESKTOP_PERSISTENCE_PRUNE_FOREST_H_
#define FIREBASE_DATABASE_SRC_DESKTOP_PERSISTENCE_PRUNE_FOREST_H_
...
#endif  // FIREBASE_DATABASE_SRC_DESKTOP_PERSISTENCE_PRUNE_FOREST_H_

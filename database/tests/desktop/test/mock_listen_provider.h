...
#ifndef FIREBASE_DATABASE_TESTS_DESKTOP_TEST_MOCK_LISTEN_PROVIDER_H_
#define FIREBASE_DATABASE_TESTS_DESKTOP_TEST_MOCK_LISTEN_PROVIDER_H_
...
#endif  // FIREBASE_DATABASE_TESTS_DESKTOP_TEST_MOCK_LISTEN_PROVIDER_H_

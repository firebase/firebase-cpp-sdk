...
/** @class FIRAuthTokenResult
    @brief A data class containing the ID token JWT string and other properties
...
/** @property authDate
    ...
    @remarks This is the date the user was signed in and NOT the date the token
   was refreshed.
 */
...
/** @property issuedAtDate
    ...
    @remarks This is the date last refreshed and NOT the last authentication
   date.
 */
...
/** @property claims
    @brief Stores the entire payload of claims found on the ID token. This
   includes the standard reserved claims as well as custom claims set by the
   developer via the Admin SDK.
 */

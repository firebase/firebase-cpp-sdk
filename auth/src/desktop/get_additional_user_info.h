...
#ifndef FIREBASE_AUTH_SRC_DESKTOP_GET_ADDITIONAL_USER_INFO_H_
#define FIREBASE_AUTH_SRC_DESKTOP_GET_ADDITIONAL_USER_INFO_H_
...
#endif  // FIREBASE_AUTH_SRC_DESKTOP_GET_ADDITIONAL_USER_INFO_H_

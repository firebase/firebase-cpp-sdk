...
#ifndef FIREBASE_AUTH_SRC_DESKTOP_IDENTITY_PROVIDER_CREDENTIAL_H_
#define FIREBASE_AUTH_SRC_DESKTOP_IDENTITY_PROVIDER_CREDENTIAL_H_
...
#endif  // FIREBASE_AUTH_SRC_DESKTOP_IDENTITY_PROVIDER_CREDENTIAL_H_

...
#ifndef FIREBASE_AUTH_SRC_DESKTOP_VISUAL_STUDIO_COMPATIBILITY_H_
#define FIREBASE_AUTH_SRC_DESKTOP_VISUAL_STUDIO_COMPATIBILITY_H_
...
#endif  // FIREBASE_AUTH_SRC_DESKTOP_VISUAL_STUDIO_COMPATIBILITY_H_

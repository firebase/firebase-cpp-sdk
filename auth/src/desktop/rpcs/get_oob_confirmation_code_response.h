...
#ifndef FIREBASE_AUTH_SRC_DESKTOP_RPCS_GET_OOB_CONFIRMATION_CODE_RESPONSE_H_
#define FIREBASE_AUTH_SRC_DESKTOP_RPCS_GET_OOB_CONFIRMATION_CODE_RESPONSE_H_

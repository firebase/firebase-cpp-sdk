...
#ifndef FIREBASE_AUTH_SRC_DESKTOP_RPCS_AUTH_RESPONSE_H_
#define FIREBASE_AUTH_SRC_DESKTOP_RPCS_AUTH_RESPONSE_H_
...
class AuthResponse
 ...
 public:
  ...
  std::string error_message() const {
    LogWarning("zzyzx AuthResponse(uid=%d).error_message(); application_data_ is %s", uid(), application_data_ ? "non-null" : "null");
